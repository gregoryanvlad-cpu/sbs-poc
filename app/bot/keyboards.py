...
def kb_vpn(*, show_my_config: bool = False) -> InlineKeyboardMarkup:
    b = InlineKeyboardBuilder()
    b.button(text="🔌 Подключиться к серверу", callback_data="vpn:bundle")
...
def kb_admin_menu() -> InlineKeyboardMarkup:
    ...
    b.button(text="🌐 Посмотреть IP сервера", callback_data="admin:outbound_ip")
    b.button(text="🗂 Пользователи по серверам", callback_data="admin:vpn:server_users")
    b.button(text="🛠 Управление VPN-серверами", callback_data="admin:vpn:servers")
    ...
    b.button(text="🧪 Тест очереди VPN", callback_data="admin:vpn:queue_sim")
    b.button(text="🧪 Выдать тестовый конфиг", callback_data="admin:vpn:test_config")
    b.button(text="🧹 Удалить тестовый конфиг", callback_data="admin:vpn:test_config:reset")
...
def kb_admin_referrals_menu() -> InlineKeyboardMarkup:
    ...
    b.button(text="🧹 Сбросить реферала", callback_data="admin:ref:reset")
