"""DB fixups for Railway where manual SQL console may be unavailable.

This module is intentionally idempotent:
- Adds payments.provider_payment_id if missing
- Adds a unique partial index for future webhook idempotency
"""
...
def _db_url() -> str:
    ...
    # If URL is sync-style, convert to asyncpg for SQLAlchemy async engine.
